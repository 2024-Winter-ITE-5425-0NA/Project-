...
const MenuItemForm: React.FC<MenuItemFormProps> = ({ onSubmit, menuItem }) => {
  ...
  const [category, setCategory] = useState<Category>(menuItem?.category || '');
    ...
    >
      ...
      >
        ...
        <div className="grow">
          ...
          <select value={category._id} onChange={ev => setCategory(categories.find(c => c._id === Number(ev.target.value)) || {} as Category)}>
